    ...
    (record, search) => {
        ...
        const put = (requestBody) => {
            ...
            try{
                ...
                let purchaseOrderId = requestBody.id;
                if (purchaseOrderId){

                
                let memo = requestBody.memo;
                let location = requestBody.location;
                let approver = requestBody.approver;
                ...
                purchaseOrder.save();
                return "Fields Updated: Memo, Location and Next Approver."
            }
            else{
                ...
                return "Invalid Purchase Order!! \n Please provide a valid Purchase Order ID";
